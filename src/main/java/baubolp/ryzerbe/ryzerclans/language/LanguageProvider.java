...
public class LanguageProvider  {
    ...
    public void load(Language language) {
        if(language == Language.GERMAN) {
            ...
            de_translations.put("help-cw-channel", "Setzte den ClanWar Channel");
            de_translations.put("help-top-clans", "Sehe die 10 besten Clans");
            de_translations.put("help-add-clan", "Füge einen Clan zu deiner Benarechtigung hinzu");
            de_translations.put("help-remove-clan", "Entferne einen Clan von deiner Benarechtigung");
            de_translations.put("help-discord", "Bugs? Feedback? Unser Discord");
            ...
            de_translations.put("help-language", "Sprache ändern?");
