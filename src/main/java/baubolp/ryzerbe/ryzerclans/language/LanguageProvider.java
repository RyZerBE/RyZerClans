...
public class LanguageProvider  {
    ...
    public void load(Language language) {
        if(language == Language.GERMAN) {
            ...
            de_translations.put("first-remove-all-before-add", "Bitte entferne erst alle Clans mit " + RyZerClans.prefix + "notify remove <Clan>");
            ...
            de_translations.put("help-top-ten", "Liste der TOP 10 CWBW Clans");
